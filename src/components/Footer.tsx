    ...
    <footer className="bg-black text-gray-400 py-12">
      <div className="w-full gap-8 px-4 ">
        <div className="mx-16">
          ...
          <p className="mb-4">
            📱 Additionally, I have a strong background in mobile development,
            proficient in frameworks like React Native and Flutter. From
            cross-platform mobile apps to native iOS and Android solutions, I
            leverage the power of these tools to deliver high-performance and
          ...
          <p className="mb-4">
            🛠️ With a solid foundation in HTML5 and CSS3, I ensure that every
            project I undertake is not only functionally robust but also
